...
public class ConstUtil {
    ...
    public static Integer ADMIN_ROLE = 1;//审核员
    public static Integer STAFF_ROLE = 2;//管理员
    public static Integer VIP_ROLE = 3;//大会员
    public static Integer USER_ROLE = 4;//普通用户
